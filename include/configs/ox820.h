...
#ifdef CONFIG_USB
#define OTP_COMMANDS (NAND_COMMANDS | CFG_CMD_USB)
#else
...
#else
#define LINUX_ROOT_DEVICE "root='$root_dev'"
#endif
#define COMMON_BOOTARGS " console=ttyS0,115200 elevator=cfq mac_adr=0x00,0x30,0xe0,0x00,0x00,0x01 rootwait ubi.mtd=2,512"
#define CONFIG_BOOTARGS LINUX_ROOT_DEVICE COMMON_BOOTARGS

#ifdef CONFIG_OXNAS_USE_SATA
#define CONFIG_BOOTDELAY	2
#define CONFIG_BOOTCOMMAND	"run dload1 boot || run dload2 boot || lightled"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    "dload1=diskboot 60500000 0:1\0" \
    "dload2=diskboot 60500000 0:2\0" \
    "root_dev1=/dev/sda2\0" \
    "root_dev2=/dev/sda1\0" \
    "root_dev=/dev/sda2\0"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
    "kernflmode=s\0" \
    "load_nand=nboot 60500000 0 200000\0" \
    "load_nand2=nboot 60500000 0 800000\0" \
    "boot=bootm 60500000\0" \
...
#define ROM_LOADER_LOAD_REDUNDANT_START_SECTOR (8 + (ROM_LOADER_LOAD_START_SECTOR) + SIZE_TO_SECTORS(UBOOT_DISK_ALLOTMENT))
#define CFG_ENV_DISK_REDUNDANT_SECTOR (ROM_LOADER_LOAD_REDUNDANT_START_SECTOR)
...
#elif (USE_NAND == 1)
/*
 * Environment is stored in a NAND flash device.
 */
#define CFG_ENV_IS_IN_NAND

/*
 * The PogoPlug Pro stores its loader environment in the 128k nand flash block
 * starting at 640k from the start of the device and maintains associated
 * Reed-Solomon ECC in this block's OOB.
 */
...
#warning Using default values for environment location and size.

#define CFG_ENV_OFFSET		0x220000
