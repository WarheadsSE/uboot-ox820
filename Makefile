...
export	ARCH CPU BOARD VENDOR SOC NAS_VERSION
...
#########################################################################
## Oxford Semiconductor Systems
#########################################################################

ox820_config :  unconfig
	@ln -s -f ./u-boot-arm11.lds ./board/oxnas/u-boot.lds
	@./mkconfig oxnas arm arm11 oxnas
	@echo "NAS_VERSION = 820" >>include/config.mk
